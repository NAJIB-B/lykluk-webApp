  ...
  return (
    <>
      ...
      <div className='relative'>
        <span className='absolute text-primary right-[2rem] top-[50%] translate-y-[-50%] underline font-medium text-[13px] cursor-pointer'>
            Send code</span>
      <AuthModalInputElement type='text' placeholder='Email verification code'></AuthModalInputElement>
      </div>
